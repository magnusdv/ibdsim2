...
As of version 2.1.0, the Shiny app is integrated into `ibdsim2`. The app depends on some packages that are not installed by default. To install everything needed by the app, use:
